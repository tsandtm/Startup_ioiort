...
var testdata = require(path.join(__dirname, 'tag.test.json'));
...
var TagRouter = (function () {
    ...
    TagRouter.prototype.setUp = function () {
        this.instance = app_2.default.listen(config.port, config.host);
        // console.log('chay setup')
    };
    TagRouter.prototype.tearDown = function () {
        this.instance.close();
        // console.log('chay Teardown')
    };
    TagRouter.prototype.getTag = function () {
        var _this = this;
        return new bluebird(function (resolve, reject) {
            _this.request.get('/Tag')
    ...
    //     //     })
    //     // }
    TagRouter.prototype.testAdd = function (v1, v2, expected) {
    ...
    ], TagRouter.prototype, "setUp", null);
    __decorate([
        alsatian_2.Teardown, 
        __metadata('design:type', Function), 
        __metadata('design:paramtypes', []), 
        __metadata('design:returntype', void 0)
    ], TagRouter.prototype, "tearDown", null);
    __decorate([
        ...
        __metadata('design:paramtypes', []), 
        __metadata('design:returntype', void 0)
    ], TagRouter.prototype, "getTag", null);
    __decorate([
        ...
        __metadata('design:returntype', void 0)
    ], TagRouter.prototype, "testAdd", null);
    return TagRouter;
}());
