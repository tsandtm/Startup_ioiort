...
app_2.default.use(express.static(path.join(__dirname, 'client')));
// load các file trong thư mục app theo đường dẫn là /app, ở đây dùng để load file main.ts
app_2.default.use('/app', express.static(path.join(__dirname, 'client')));
// load các file script được ghi trong file index.html với đường dẫn là /scripts
app_2.default.use('/scripts', loadModule_middleware_1.javaScripts);
// load các file @angular được khai báo trong systemjs.config.js
app_2.default.use('/scripts', loadModule_middleware_1.angularModule);
// load các file thư viện khác được khai báo trong systemjs.config.js
app_2.default.use('/scripts', loadModule_middleware_1.othersLib);
// load các file css cho client
app_2.default.use('/css', loadModule_middleware_1.cssFiles);
// load các file html cho client
app_2.default.use(loadModule_middleware_1.htmlFiles);
// trả về index.html
app_2.default.get('/', function (req, res) {
    res.sendFile('index.html');
});
app_2.default.listen(config.port);
