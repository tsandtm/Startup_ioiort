...
var SettingEditComponent = (function () {
    function SettingEditComponent(settingservice, _router, _route) {
        this.settingservice = settingservice;
        this._router = _router;
        this._route = _route;
        this.pageTitle = 'Setting Edit';
        console.log(this._route.snapshot.params['id']);
    }
    SettingEditComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    SettingEditComponent.prototype.getSetting = function (id) {
        var _this = this;
        this.settingservice.getOne(id)
            .then(function (setting) { return _this.setting = setting; });
    };
    SettingEditComponent.prototype.Edit = function () {
        var _this = this;
        if (this.setting.IsActive == undefined)
            this.setting.IsActive = false;
        this.settingservice.Edit(this.setting).then(function (result) { return _this._router.navigate(['setting-list']); });
    };
    SettingEditComponent.prototype.Back = function () {
