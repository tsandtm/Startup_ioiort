...
export class NotificationRouter {
    ...
    private getAllNotification = (req: Request, res: Response) => {
        let option = { Notification_Tag: req.query.Notification_Tag };

        this.notificationRepo.getList(option)
            .then(result => {
    ...
    // private createANotification = (req, res) => {
    //     res.send('created')
    // }

    // private deleteANotification = (req, res) => {
    //     res.send('deleted')
    // }
