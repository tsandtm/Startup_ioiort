...
export class UsersRouter {
    ...
    public getRouter(): Router {
        ...
        this.router.get('/countUser',this.countUser)
        console.log('abc');
    ...
    private getAllUsers = (req: Request, res: Response) => {
        ...
        this.usersRepo.getList(req.body)
            .then(result => {
    ...
    private countUser = (req: Request,res: Response) => {
        this.usersRepo.count(null)
            .then(result => {
                res.status(200).json(result);
            })
            .catch(error => {
    ...
    private Create = (req: Request, res: Response) => {
        this.usersRepo.Create(req.body)
            .then(result => {
                res.status(200).json(result)
            })
            .catch(error => {
